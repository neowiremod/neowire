...
gamt = {
	...
	__call = function(t, s)
		--call the table to set a default category
...
LoadWireGates()
local banned_categories_convar =
	CreateConVar("wire_banned_gate_categories", "", { FCVAR_ARCHIVE, FCVAR_REPLICATED, FCVAR_NOTIFY }, "For multiple categories, separate them with commas. If you change this, existing gates won't be affected.")
