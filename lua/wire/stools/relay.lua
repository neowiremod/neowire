...
if SERVER then
	function TOOL:GetConVars()
		return self:GetClientNumber("keygroup1"),
			self:GetClientNumber("keygroup2"),
			self:GetClientNumber("keygroup3"),
			self:GetClientNumber("keygroup4"),
			self:GetClientNumber("keygroup5"),
			self:GetClientNumber("keygroupoff"),
			self:GetClientNumber("toggle") ~= 0,
			self:GetClientNumber("normclose"),
			self:GetClientNumber("poles"),
			self:GetClientNumber("throws"),
			self:GetClientNumber("nokey") ~= 0
	end
end

function TOOL.BuildCPanel(panel)
	panel:AddControl("Header", {
		Text = "#Tool.wire_relay.name",
		Description = "#Tool.wire_relay.desc",
	})
	...
	panel:AddControl("ComboBox", {
		...
		Options = {
			["Open"] = {
				wire_relay_normclose = "0",
			},
			["Closed to 1"] = {
				wire_relay_normclose = "1",
			},
			["Closed to 2"] = {
				wire_relay_normclose = "2",
			},
			["Closed to 3"] = {
				wire_relay_normclose = "3",
			},
			["Closed to 4"] = {
				wire_relay_normclose = "4",
			},
			["Closed to 5"] = {
				wire_relay_normclose = "5",
			},
		},
	})
	...
	panel:AddControl("Numpad", {
		Label = "#WireRelayTool_keygroupoff",
		Label2 = "#WireRelayTool_keygroup1",
		Command = "wire_relay_keygroupoff",
		Command2 = "wire_relay_keygroup1",
		ButtonSize = "22",
	})

	panel:AddControl("Numpad", {
		Label = "#WireRelayTool_keygroup2",
		Label2 = "#WireRelayTool_keygroup3",
		Command = "wire_relay_keygroup2",
		Command2 = "wire_relay_keygroup3",
		ButtonSize = "22",
	})

	panel:AddControl("Numpad", {
		Label = "#WireRelayTool_keygroup4",
		Label2 = "#WireRelayTool_keygroup5",
		Command = "wire_relay_keygroup4",
		Command2 = "wire_relay_keygroup5",
		ButtonSize = "22",
	})
end
