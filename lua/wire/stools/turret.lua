...
TOOL.GetGhostMin = function()
	return -2
end
if SERVER then
	function TOOL:GetConVars()
		return self:GetClientNumber("delay"),
			self:GetClientNumber("damage"),
			self:GetClientNumber("force"),
			self:GetClientInfo("sound"),
			self:GetClientNumber("numbullets"),
			self:GetClientNumber("spread"),
			self:GetClientInfo("tracer"),
			self:GetClientNumber("tracernum")
	end
end
...
function TOOL.BuildCPanel(CPanel)
	...
	-- Shot sounds
	local weaponSounds = {
		Label = "#Tool_wire_turret_sound",
		MenuButton = 0,
		Options = {},
		CVars = {},
	}

	weaponSounds["Options"]["#No Weapon"] = {
		wire_turret_sound = "",
	}

	weaponSounds["Options"]["#Pistol"] = {
		wire_turret_sound = "Weapon_Pistol.Single",
	}

	weaponSounds["Options"]["#SMG"] = {
		wire_turret_sound = "Weapon_SMG1.Single",
	}

	weaponSounds["Options"]["#AR2"] = {
		wire_turret_sound = "Weapon_AR2.Single",
	}

	weaponSounds["Options"]["#Shotgun"] = {
		wire_turret_sound = "Weapon_Shotgun.Single",
	}

	weaponSounds["Options"]["#Floor Turret"] = {
		wire_turret_sound = "NPC_FloorTurret.Shoot",
	}

	weaponSounds["Options"]["#Airboat Heavy"] = {
		wire_turret_sound = "Airboat.FireGunHeavy",
	}

	weaponSounds["Options"]["#Zap"] = {
		wire_turret_sound = "ambient.electrical_zap_3",
	}
	...
	TracerType["Options"]["#Default"] = {
		wire_turret_tracer = "Tracer",
	}

	TracerType["Options"]["#AR2 Tracer"] = {
		wire_turret_tracer = "AR2Tracer",
	}

	TracerType["Options"]["#Airboat Tracer"] = {
		wire_turret_tracer = "AirboatGunHeavyTracer",
	}

	TracerType["Options"]["#Laser"] = {
		wire_turret_tracer = "LaserTracer",
	}
