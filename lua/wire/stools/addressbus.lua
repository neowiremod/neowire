...
if CLIENT then
	...
	TOOL.Information = {
		{
			name = "left",
			text = "Create/Update address bus",
		},
	}
end
...
if SERVER then
	function TOOL:GetConVars()
		return self:GetClientNumber("addrspace1st"),
			...
			self:GetClientNumber("addrspace1rw"),
			self:GetClientNumber("addrspace2rw"),
			self:GetClientNumber("addrspace3rw"),
			self:GetClientNumber("addrspace4rw")
	end
