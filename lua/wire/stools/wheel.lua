...
if SERVER then
	...
	function TOOL:MakeEnt(ply, model, Ang, trace)
		...
		if fwd == stop or bck == stop or fwd == bck then
			return false
		end
		-- Create the wheel
		local wheelEnt = WireLib.MakeWireEnt(ply, {
	...
	function TOOL:LeftClick_PostMake(_, _, _) -- We're handling this in MakeEnt since theres a motor
	end
end
