	...
	for k, v in pairs(Wire_Keyboard_Remap) do
		...
		if k == curlayout then
			...
			timer.Simple(0, function()
				languages:ChooseOptionID(curindex) -- This needs to be delayed or it'll set the box to show "0"
			end)
		end
	end

	panel:Help(
		"The selected language is clientside. Any keyboard you use, created by any player, will use your selection. If your keyboard layout is not available in this list, you are welcome to create it and post it as a pull request on the wiremod github page."
	)
