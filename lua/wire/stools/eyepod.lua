...
if SERVER then
	function TOOL:GetConVars()
		...
		local ClampY = 0
		--test clamp
		if (ClampXMin ~= 0 or ClampXMax ~= 0) and (ClampYMin ~= 0 or ClampYMax ~= 0) and ClampXMin ~= ClampXMax and ClampYMin ~= ClampYMax and ClampXMin < ClampXMax and ClampYMin < ClampYMax then
			ClampX = 1
			ClampY = 1
