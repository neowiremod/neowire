...
if SERVER then
	function FLIR.start(ply)
		FLIR.enable(ply, true)
	end

	function FLIR.stop(ply)
		FLIR.enable(ply, false)
	end
...
function FLIR.start()
	...
	hook.Add("PostDraw2DSkyBox", "wire_flir", function()
		--overrides 2d skybox to be gray, as it normally becomes white or black
