...
WireLib.ThrusterEffectDraw.fire_smoke_big = function(self)
	...
	if self.RingTimer > CurTime() then
		return
	end
...
WireLib.ThrusterEffectThink.smoke = smoke(function()
	return 200, 200, 210
end)
WireLib.ThrusterEffectThink.smoke_firecolors = smoke(function()
	return math.random(220, 255), math.random(110, 220), 0
end)
WireLib.ThrusterEffectThink.smoke_random = smoke(function()
	return math.random(100, 255), math.random(100, 255), math.random(100, 255)
end)
WireLib.ThrusterEffectThink.smoke_diy = smoke(function(self)
	local c = self:GetColor()
	return c.r, c.g, c.b
end)
...
WireLib.ThrusterEffectThink.jetflame = jetflame(function()
	return math.Rand(220, 255), math.Rand(180, 220), 55
end)
WireLib.ThrusterEffectThink.jetflame_purple = jetflame(function()
	return math.Rand(220, 255), 55, math.Rand(180, 220)
end)
WireLib.ThrusterEffectThink.jetflame_red = jetflame(function()
	return math.Rand(220, 255), 55, 55
end)
WireLib.ThrusterEffectThink.jetflame_blue = jetflame(function()
	return 55, 55, math.Rand(220, 255)
end)
WireLib.ThrusterEffectThink.jetflame_diy = jetflame(function(self)
	local c = self:GetColor()
	return c.r, c.g, c.b
end)
...
WireLib.ThrusterEffectThink.balls_firecolors = balls(function()
	return math.random(220, 255), math.random(100, 200), 0
end)
WireLib.ThrusterEffectThink.balls_random = balls(function()
	return math.random(0, 255), math.random(0, 255), math.random(0, 255)
end)
WireLib.ThrusterEffectThink.balls = balls(function(self)
...
WireLib.ThrusterEffectThink.magic_firecolors = magic(function()
	return math.random(220, 255), math.random(100, 200), 0
end)
WireLib.ThrusterEffectThink.magic = magic(function()
	return 255, 255, 255
end)
WireLib.ThrusterEffectThink.magic_diy = magic(function(self)
	local c = self:GetColor()
	return c.r, c.g, c.b
end)

WireLib.ThrusterEffectThink.magic_color = magic(function()
	return math.random(0, 255), math.random(0, 255), math.random(0, 255)
end)
