...
ModelPlug.ListAddModels(
	"WireNoGPULibScreenModels",
	{ "models/props_lab/monitor01b.mdl", "models/props/cs_office/tv_plasma.mdl", "models/props/cs_office/computer_monitor.mdl", "models/kobilica/wiremonitorbig.mdl", "models/kobilica/wiremonitorsmall.mdl" }
)
--sounds
...
ModelPlug.ListAddModels("WheelModels", { "models/props_wasteland/wheel01a.mdl", "models/props_wasteland/wheel02a.mdl", "models/props_wasteland/wheel03a.mdl", "models/props_wasteland/wheel03b.mdl" }, {
	wheel_rx = 90,
	wheel_ry = 0,
	wheel_rz = 90,
})
...
ModelPlug.ListAddModels("ThrusterModels", { "models/props_junk/garbage_metalcan001a.mdl", "models/jaanus/thruster_flat.mdl", "models/fasteroid/computerfan.mdl" })
ModelPlug.ListAddModels(
	"Wire_Explosive_Models",
	{
...
ModelPlug.ListAddModels(
	"WireTurretModels",
	{ "models/weapons/w_smg1.mdl", "models/weapons/w_smg_mp5.mdl", "models/weapons/w_smg_mac10.mdl", "models/weapons/w_rif_m4a1.mdl", "models/weapons/w_357.mdl", "models/weapons/w_shot_m3super90.mdl" }
)
ModelPlug.ListAddModels("Wire_satellitedish_Models", { "models/props_wasteland/prison_lamp001c.mdl", "models/props_rooftop/satellitedish02.mdl" })
ModelPlug.ListAddModels(
	"Wire_Light_Models",
	{ "models/jaanus/wiretool/wiretool_range.mdl", "models/jaanus/wiretool/wiretool_siren.mdl", "models/MaxOfS2D/light_tubular.mdl", "models/fasteroid/led_mini.mdl", "models/fasteroid/led_nano.mdl" }
)
ModelPlug.ListAddModels("Wire_Keyboard_Models", { "models/beer/wiremod/keyboard.mdl", "models/jaanus/wiretool/wiretool_input.mdl", "models/props_c17/computer01_keyboard.mdl" })
ModelPlug.ListAddModels("Wire_Hydraulic_Models", { "models/beer/wiremod/hydraulic.mdl", "models/jaanus/wiretool/wiretool_siren.mdl", "models/xqm/hydcontrolbox.mdl" })
ModelPlug.ListAddModels("Wire_GPS_Models", { "models/beer/wiremod/gps.mdl", "models/jaanus/wiretool/wiretool_speed.mdl" })
ModelPlug.ListAddModels("Wire_Numpad_Models", { "models/beer/wiremod/numpad.mdl", "models/jaanus/wiretool/wiretool_input.mdl", "models/jaanus/wiretool/wiretool_output.mdl" })
ModelPlug.ListAddModels("Wire_WaterSensor_Models", { "models/beer/wiremod/watersensor.mdl", "models/jaanus/wiretool/wiretool_range.mdl" })
ModelPlug.ListAddModels("Wire_TargetFinder_Models", { "models/beer/wiremod/targetfinder.mdl", "models/props_lab/powerbox02d.mdl" })
ModelPlug.ListAddModels("Wire_Forcer_Models", { "models/jaanus/wiretool/wiretool_grabber_forcer.mdl", "models/jaanus/wiretool/wiretool_siren.mdl", "models/fasteroid/computerfan.mdl" })
ModelPlug.ListAddModels("Wire_Misc_Tools_Models", { "models/jaanus/wiretool/wiretool_range.mdl", "models/jaanus/wiretool/wiretool_siren.mdl", "models/props_lab/powerbox02d.mdl" })
--Laser Tools (Ranger, User, etc)
ModelPlug.ListAddModels("Wire_Laser_Tools_Models", { "models/jaanus/wiretool/wiretool_range.mdl", "models/jaanus/wiretool/wiretool_siren.mdl", "models/jaanus/wiretool/wiretool_beamcaster.mdl", "models/fasteroid/led_mini.mdl" })
ModelPlug.ListAddModels(
	"Wire_button_small_Models",
	{
...
ModelPlug.ListAddModels("Wire_detonator_Models", { "models/jaanus/wiretool/wiretool_detonator.mdl", "models/props_combine/breenclock.mdl" })
ModelPlug.ListAddModels("Wire_dynamic_button_Models", { "models/bull/dynamicbutton.mdl", "models/bull/dynamicbuttonflat.mdl", "models/bull/dynamicbuttonmedium.mdl", "models/maxofs2d/button_05.mdl" })
ModelPlug.ListAddModels("Wire_dynamic_button_small_Models", { "models/bull/dynamicbutton_small.mdl", "models/bull/dynamicbuttonflat_small.mdl", "models/bull/dynamicbuttonmedium_small.mdl" })
ModelPlug.ListAddModels("Wire_expr2_Models", { "models/expression 2/cpu_controller.mdl", "models/expression 2/cpu_expression.mdl", "models/expression 2/cpu_microchip.mdl" })
ModelPlug.ListAddModels(
	"Wire_gate_Models",
	{
		"models/bull/gates/capacitor.mdl",
...
ModelPlug.ListAddModels("Wire_gyroscope_Models", { "models/bull/various/gyroscope.mdl", "models/cheeze/wires/gyroscope.mdl" })
ModelPlug.ListAddModels(
	"Wire_indicator_Models",
	{
...
ModelPlug.ListAddModels(
	"Wire_radio_Models",
	{ "models/cheeze/wires/router.mdl", "models/cheeze/wires/wireless_card.mdl", "models/props_lab/binderblue.mdl", "models/props_lab/reciever01a.mdl", "models/props_lab/reciever01b.mdl", "models/props_lab/reciever01c.mdl" }
)
ModelPlug.ListAddModels(
	"Wire_speaker_Models",
	{
...
ModelPlug.ListAddModels("Wire_weight_Models", { "models/props_interiors/pot01a.mdl", "models/props_lab/huladoll.mdl" })
ModelPlug.ListAddModels(
	"Wire_InteractiveProp_Models",
	{
		"models/props_lab/reciever01a.mdl",
		"models/props_lab/reciever01b.mdl",
		"models/props_lab/keypad.mdl",
