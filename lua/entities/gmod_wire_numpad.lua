...
local keynames = {
	"0", -- Names as we will display them and for inputs/outputs
	"1",
	"2",
	"3",
	"4",
...
local keyenums = {
	37, -- Same indexes as keynames, values are the corresponding KEY_* enums
	38,
	39,
	40,
	41,
...
local nametoenum = {}
for k, v in ipairs(keynames) do -- Indexes are string input/output names, values are the corresponding KEY_* enums
