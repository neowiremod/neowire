...
function E2Lib.Validate(buffer)
	if not e2_function_data_received then
		return { Error.new("Loading extensions. Please try again in a few seconds...") }
	end
	---@type Warning[], Error[]
